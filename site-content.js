document.addEventListener('DOMContentLoaded', async () => {
  ...
  const textBindings = {
    '/': {
      ...
      'home.projects.kicker': '.section-head .eyebrow',
      'home.projects.title': '.section-head h2',
      'home.projects.text': '.section-head p',
      'home.about.kicker': '.signature-card .eyebrow',
      'home.about.title': '.signature-card h3',
      'home.about.quote': '.quote-card',
      'home.form.kicker': '.contact-grid .eyebrow',
      'home.form.title': '.contact-grid h2',
      'home.form.text': '.contact-grid p',
    },
    '/projects/': {
